...
func (s *Service) GetCurrentVersion(ctx context.Context, credentials *domain.UserCredentials, pageID uuid.UUID, versionId int64) (*domain.Version, error) {
...
func (s *Service) GetLastVersion(ctx context.Context, credentials *domain.UserCredentials, pageID uuid.UUID) (*domain.Version, error) {
	if !hasRequiredPermission(credentials.Role, domain.RoleViewer) {
...
func (s *Service) ListVersions(ctx context.Context, credentials *domain.UserCredentials, pageID uuid.UUID, limit, offset int32) ([]domain.Version, error) {
	if !hasRequiredPermission(credentials.Role, domain.RoleViewer) {
